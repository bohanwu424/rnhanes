...
for(i in 1:n){
  ...
  Act_i =  Act_Analysis[ind,paste0("MIN",times)]
  ...
  wkday[i] = Act_Analysis[ind,]$WEEKDAY
}
Act = Act_Analysis[complete.cases(Act_Analysis) ,paste0("MIN",times)]
...
save(X, Y, tau, svywt,seqn, file = paste('pa_nhanes_', k_min, 'min2.RData', sep=''))
